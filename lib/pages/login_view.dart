...
class LoginView extends StatelessWidget {
  ...
  Column formLogin() {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      const SizedBox(height: 15),
      Text(kT16, style: GoogleFonts.nunitoSans(textStyle: const TextStyle(color: kFifthColor, fontSize: 18))),
      const TextField(
          obscureText: true,
          decoration: InputDecoration(
              hintText: kT17,
  ...
  Container backgroundImage() {
    return Container(
        height: Get.height * 0.55,
        decoration: const BoxDecoration(image: DecorationImage(image: AssetImage(kImage4), fit: BoxFit.cover)));
  }
}
